...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+92) 334 3788150",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "mduaa0976@gmail.com",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
      ...
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row gap-[30px]">
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form
              action="https://formspree.io/f/xanyodjl"
              method="POST"
...
// import {Select, SelectContent, SelectGroup, Selection, SelectLabel, SelectTrigger, SelectValue,} from "@/components/ui/select";
